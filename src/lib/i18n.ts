...
const translations = {
  ...
  allActivity: { en: 'All Activity', ar: 'كل النشاط' },
  deals: { en: 'Deals', ar: 'الصفقات' },
  invites: { en: 'Invites', ar: 'الدعوات' },
  approvals: { en: 'Approvals', ar: 'الموافقات' },
  ...
  dealFamily: { en: 'Deal Family', ar: 'نوع الصفقة' },
  ...
  partnerSharePct: { en: 'Partner Share %', ar: 'نسبة الشريك %' },
  yourSharePct: { en: 'Your Share %', ar: 'نسبتك %' },
