...
const translations = {
  ...
  uxferHint: { en: 'Not an order: moves USDT in or out of stock through FIFO with no revenue and no profit. Borrowed USDT is costed at the price of the stock you buy to repay it.', ar: 'ليست طلبًا: تُدخل أو تُخرج USDT من المخزون عبر FIFO بدون إيراد أو ربح. يُحتسب الـ USDT المقترض بسعر المخزون الذي تشتريه لسداده.' },
  ...
  uxferRefPrice: { en: 'Reference price (optional)', ar: 'السعر المرجعي (اختياري)' },
  uxferRefPriceHint: { en: 'Used as the cost of borrowed USDT only until it is repaid. Blank = nearest purchase price.', ar: 'يُستخدم كتكلفة الـ USDT المقترض فقط حتى يتم سداده. فارغ = أقرب سعر شراء.' },
  uxferNote: { en: 'Note', ar: 'ملاحظة' },
  uxferSave: { en: 'Record movement', ar: 'تسجيل الحركة' },
  uxferIOwe: { en: 'I owe', ar: 'عليّ' },
  uxferOwesMe: { en: 'Owes me', ar: 'لي' },
  uxferSettled: { en: 'Settled', ar: 'مُسوّى' },
  uxferBalances: { en: 'Open balances', ar: 'الأرصدة المفتوحة' },
  uxferHistory: { en: 'History', ar: 'السجل' },
  uxferEmpty: { en: 'No borrow / lend movements yet.', ar: 'لا توجد حركات اقتراض / إقراض بعد.' },
  uxferDelete: { en: 'Delete', ar: 'حذف' },
  uxferDeleteConfirm: { en: 'Delete this movement? Stock and FIFO costs will be recalculated.', ar: 'حذف هذه الحركة؟ سيُعاد حساب المخزون وتكاليف FIFO.' },
  ...
  uxferRepay: { en: 'Repay', ar: 'سداد' },
  uxferCollect: { en: 'Received back', ar: 'استلام' },
  uxferInStock: { en: 'In stock', ar: 'في المخزون' },
