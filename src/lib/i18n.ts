...
const translations = {
  ...
  availableUsdt: { en: 'AVAILABLE دولار', ar: 'دولار المتاح' },
  liquidUsdt: { en: 'Liquid دولار ready for deployment', ar: 'دولار سائل جاهز للاستخدام' },
  ...
  p2pTop5Qty: { en: 'Top 5 Biggest دولار Qty', ar: 'أفضل 5 من حيث كمية دولار' },
  ...
  amountUsdt: { en: 'Amount (دولار)', ar: 'المبلغ (دولار)' },
  sellPrice: { en: 'Sell Price (ريال)', ar: 'سعر البيع (ر.ق)' },
  ...
  entryModeUsdtQar: { en: '📦 دولار + ريال', ar: '📦 دولار + ر.ق' },
  entryModeUsdtPrice: { en: '📊 دولار + Price', ar: '📊 دولار + السعر' },
  totalUsdtSold: { en: 'Total دولار Sold', ar: 'إجمالي دولار المباع' },
  totalQarReceived: { en: 'Total ريال Received', ar: 'إجمالي ر.ق المستلم' },
  autoCalcSellPrice: { en: 'Auto Sell Price', ar: 'سعر البيع التلقائي' },
  autoCalcTotalQar: { en: 'Auto Total ريال', ar: 'إجمالي ر.ق التلقائي' },
  quantity: { en: 'Quantity', ar: 'الكمية' },
  amountQar: { en: 'Amount (ريال)', ar: 'المبلغ (ر.ق)' },
  ...
  quantityUsdt: { en: 'Quantity (دولار)', ar: 'الكمية (دولار)' },
  sellPriceQar: { en: 'Sell Price (ريال)', ar: 'سعر البيع (ر.ق)' },
  ...
  totalUsdt: { en: 'Total دولار', ar: 'إجمالي دولار' },
  ...
  buyPriceQar: { en: 'Buy Price (ريال)', ar: 'سعر الشراء (ر.ق)' },
  volumeQar: { en: 'Volume (ريال)', ar: 'الحجم (ر.ق)' },
  ...
  qtyUsdt: { en: 'Qty دولار', ar: 'الكمية دولار' },
  usdtBought: { en: 'دولار Bought', ar: 'دولار المشتراة' },
  totalQarPaid: { en: 'Total ريال Paid', ar: 'إجمالي ر.ق المدفوع' },
  avgPriceCalc: { en: 'Avg Price:', ar: 'متوسط السعر:' },
  totalQarCalc: { en: 'Total ريال:', ar: 'إجمالي ر.ق:' },
  ...
  usdtQtyValidation: { en: 'دولار Qty', ar: 'كمية دولار' },
  totalQarValidation: { en: 'Total ريال', ar: 'إجمالي ر.ق' },
  ...
  totalQar: { en: 'Total ريال', ar: 'إجمالي ر.ق' },
  ...
  lowStockThreshold: { en: 'Low stock threshold (دولار)', ar: 'حد المخزون المنخفض (دولار)' },
  ...
  amountUsdtLabel: { en: 'Amount (دولار)', ar: 'المبلغ (دولار)' },
  ...
  feeQarLabel: { en: 'Fee ريال', ar: 'الرسوم ر.ق' },
  ...
  batchFullyDepletedWarn: { en: 'Fully depleted — all دولار consumed by FIFO trades. Editing qty/price will trigger full FIFO recompute.', ar: 'مستنفدة بالكامل — تم استهلاك كل دولار بواسطة صفقات FIFO. تعديل الكمية/السعر سيعيد حساب FIFO بالكامل.' },
  ...
  dealStockReserved: { en: 'Stock reserved: {amount} دولار allocated to this deal', ar: 'تم حجز المخزون: {amount} دولار مخصص لهذه الصفقة' },
  ...
  dealWillReserveStock: { en: 'This deal will reserve {amount} دولار from available stock', ar: 'هذه الصفقة ستحجز {amount} دولار من المخزون المتاح' },
  ...
  liquiditySharedUsdt: { en: 'Shared دولار', ar: 'دولار المنشور' },
  ...
  liquidityCashPlusUsdt: { en: 'Cash + دولار', ar: 'نقد + دولار' },
  liquidityCashOnly: { en: 'Cash only', ar: 'نقد فقط' },
  liquidityUsdtOnly: { en: 'دولار only', ar: 'دولار فقط' },
  ...
  liquidityNeedUsdt: { en: 'Need دولار', ar: 'أحتاج دولار' },
  ...
  costBasisQar: { en: 'Cost Basis (ريال/دولار)', ar: 'سعر التكلفة (ريال/دولار)' },
  ...
  usdtTransfers: { en: 'دولار Transfers', ar: 'تحويلات دولار' },
  capitalTransfersDesc: { en: 'Pure دولار capital movements between operator and lender', ar: 'حركات رأس المال دولار بين المشغل والمقرض' },
  ...
  simGrossProfit: { en: 'Gross Profit (دولار)', ar: 'الربح الإجمالي (دولار)' },
  ...
  simConversionRate: { en: 'دولار → ريال Rate', ar: 'سعر دولار → ريال' },
  simFifoRate: { en: 'FIFO Avg Buy', ar: 'متوسط شراء FIFO' },
  simQarEquivalent: { en: 'ريال Equivalent', ar: 'المعادل بالريال' },
  ...
  allocatedUsdt: { en: 'Allocated دولار', ar: 'دولار المخصص' },
  merchantCostUsdt: { en: 'Merchant Cost/دولار', ar: 'تكلفة التاجر/دولار' },
  addMerchantAllocation: { en: '+ Add Merchant Allocation', ar: '+ إضافة تخصيص تاجر' },
  allocSummary: { en: 'Allocation Summary', ar: 'ملخص التخصيص' },
  totalSaleUsdt: { en: 'Total Sale دولار', ar: 'إجمالي البيع دولار' },
  ...
  allocationMustMatch: { en: 'Allocated دولار must exactly match total sale quantity', ar: 'يجب أن يتطابق دولار المخصص تماماً مع إجمالي كمية البيع' },
  ...
  qarSpent:              { en: 'ريال spent',                    ar: 'ر.ق أُنفق' },
  ...
  amountInQar:             { en: 'Amount in ريال',                       ar: 'المبلغ بالريال' },
  ...
  allocMismatchDetail:     { en: 'allocated {0} دولار but sale is {1} دولار', ar: 'تم تخصيص {0} دولار لكن البيع {1} دولار' },
  ...
  allocNeedsUsdt:          { en: 'Each allocation must have دولار amount > 0', ar: 'كل تخصيص يجب أن يحتوي على مبلغ دولار أكبر من 0' },
  ...
  convertedFromQar:             { en: 'Converted from ريال using avg rate',  ar: 'محوّل من ر.ق باستخدام متوسط السعر' },
  convertedFromUsdt:            { en: 'Equivalent in ريال',                  ar: 'المعادل بالريال القطري' },
  noRateAvailable:              { en: 'No rate available for conversion',   ar: 'لا يوجد سعر متاح للتحويل' },
  capitalInUsdt:                { en: 'دولار',                               ar: 'دولار' },
  capitalInQar:                 { en: 'ريال',                                ar: 'ر.ق' },
