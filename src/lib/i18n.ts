...
const translations = {
  ...
  uxferReceivedHint: { en: 'Stock batches and Binance/OKX transfers you received. Tag the ones a merchant lent you, or that came back from a merchant you lent to.', ar: 'دفعات المخزون وتحويلات Binance/OKX التي استلمتها. علّم ما أقرضك إياه تاجر، أو ما أُعيد إليك من تاجر أقرضته.' },
  uxferSentHint: { en: 'Orders and Binance/OKX transfers you sent. Tag the ones that paid back a merchant you borrowed from, or that you lent to a merchant.', ar: 'الطلبات وتحويلات Binance/OKX التي أرسلتها. علّم ما سددت به تاجرًا اقترضت منه، أو ما أقرضته لتاجر.' },
