...
const translations = {
  ...
  reconcileOpenOrders: { en: 'Register on Orders', ar: 'سجّل في الطلبات' },
  reconcileBuysBelow: { en: 'Buys: import them from the exchange list in Add batch.', ar: 'المشتريات: استوردها من قائمة المنصات في إضافة دفعة.' },
  ...
  // ── USDT borrow / lend between merchants ──
  uxferTab: { en: 'Borrow / Lend', ar: 'اقتراض / إقراض' },
  uxferTitle: { en: 'USDT borrowed & lent between merchants', ar: 'USDT المقترض والمُقرض بين التجار' },
  uxferKindBorrowIn: { en: 'Borrowed (received)', ar: 'اقترضت (استلمت)' },
  uxferKindBorrowRepay: { en: 'Repaid borrow (sent back)', ar: 'سددت القرض (أرسلت)' },
  uxferKindLendOut: { en: 'Lent out (sent)', ar: 'أقرضت (أرسلت)' },
  uxferKindLendReturn: { en: 'Loan returned (received back)', ar: 'استرددت القرض (استلمت)' },
  uxferCounterparty: { en: 'Merchant', ar: 'التاجر' },
  uxferAmount: { en: 'USDT amount', ar: 'كمية USDT' },
  uxferSave: { en: 'Record movement', ar: 'تسجيل الحركة' },
  uxferIOwe: { en: 'I owe', ar: 'عليّ' },
  uxferOwesMe: { en: 'Owes me', ar: 'لي' },
  uxferBalances: { en: 'Open balances', ar: 'الأرصدة المفتوحة' },
  uxferEmpty: { en: 'No borrow / lend movements yet.', ar: 'لا توجد حركات اقتراض / إقراض بعد.' },
  uxferErrName: { en: 'Enter the merchant name', ar: 'أدخل اسم التاجر' },
  uxferErrAmount: { en: 'Enter a USDT amount greater than zero', ar: 'أدخل كمية USDT أكبر من صفر' },
  uxferErrStock: { en: 'Not enough USDT in stock to send this amount', ar: 'لا يوجد USDT كافٍ في المخزون لإرسال هذه الكمية' },
  uxferRecorded: { en: 'Movement recorded', ar: 'تم تسجيل الحركة' },
  uxferHint: { en: 'Pick the USDT you received or sent below and tag what it really was. A tagged order is no longer a sale and a tagged batch is no longer a purchase — no revenue, no profit. When you repay, the borrowed USDT is costed at the price of the stock you bought to repay it.', ar: 'اختر الـ USDT الذي استلمته أو أرسلته أدناه وحدّد ما كان عليه فعلًا. الطلب المُعلَّم لم يعد بيعًا والدفعة المُعلَّمة لم تعد شراءً — بدون إيراد أو ربح. عند السداد تُحتسب تكلفة الـ USDT المقترض بسعر المخزون الذي اشتريته لسداده.' },
  uxferReceived: { en: 'Received', ar: 'المستلم' },
  uxferSent: { en: 'Sent', ar: 'المُرسل' },
  uxferReceivedHint: { en: 'Stock batches plus every Binance/OKX P2P order and transfer you received — imported or not. Tag the ones a merchant lent you, or that came back from a merchant you lent to.', ar: 'دفعات المخزون وكل طلبات P2P وتحويلات Binance/OKX التي استلمتها — مستوردة أو لا. علّم ما أقرضك إياه تاجر، أو ما أُعيد إليك من تاجر أقرضته.' },
  uxferSentHint: { en: 'Orders plus every Binance/OKX P2P order and transfer you sent — even ones you left unimported on the Orders page. Tick several to tag them together. Tag the ones that paid back a merchant you borrowed from, or that you lent to a merchant.', ar: 'الطلبات وكل طلبات P2P وتحويلات Binance/OKX التي أرسلتها — حتى التي لم تستوردها في صفحة الطلبات. حدّد عدة سجلات لتعليمها معًا. علّم ما سددت به تاجرًا اقترضت منه، أو ما أقرضته لتاجر.' },
  uxferSearch: { en: 'Search by name, amount or date…', ar: 'ابحث بالاسم أو الكمية أو التاريخ…' },
  uxferTagBorrowed: { en: 'Borrowed', ar: 'مقترض' },
  uxferTagReturned: { en: 'Returned', ar: 'مُعاد' },
  uxferTagRepaid: { en: 'Repayment', ar: 'سداد' },
  uxferTagLent: { en: 'Lent', ar: 'إقراض' },
  uxferSrcManual: { en: 'Manual entry', ar: 'إدخال يدوي' },
  uxferSrcBatch: { en: 'Stock batch', ar: 'دفعة مخزون' },
  uxferSrcOrder: { en: 'Order', ar: 'طلب' },
  uxferSrcTransfer: { en: 'Transfer', ar: 'تحويل' },
  uxferDismissed: { en: 'hidden from inbox', ar: 'مخفي من الوارد' },
  uxferLockedOrder: { en: 'Merchant-linked order — cancel it on the Orders page first', ar: 'طلب مرتبط بتاجر — ألغِه من صفحة الطلبات أولًا' },
  uxferConfirm: { en: 'Confirm', ar: 'تأكيد' },
  uxferUndo: { en: 'Undo', ar: 'تراجع' },
  uxferUndoConfirm: { en: 'Undo this tag? The record goes back to being an order / stock purchase and FIFO is recalculated.', ar: 'التراجع عن هذا التصنيف؟ يعود السجل طلبًا / شراء مخزون ويُعاد حساب FIFO.' },
