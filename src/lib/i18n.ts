...
const translations = {
  ...
  statementsTabDesc: { en: 'Create a public, read-only link for a buyer to view their own statement — no login required.', ar: 'أنشئ رابطًا عامًا للقراءة فقط ليطّلع العميل على كشف حسابه دون تسجيل دخول.' },
  statementLinkStatus: { en: 'Link', ar: 'الرابط' },
  statementLinkActive: { en: 'Active', ar: 'مفعّل' },
  statementLinkNone: { en: 'None', ar: 'لا يوجد' },
  statementLinkGetLink: { en: 'Get shareable link', ar: 'إنشاء رابط مشاركة' },
  statementLinkCopy: { en: 'Copy link', ar: 'نسخ الرابط' },
  statementLinkRevoke: { en: 'Revoke', ar: 'إلغاء' },
  statementLinkCreated: { en: 'Statement link created', ar: 'تم إنشاء رابط الكشف' },
  statementLinkCreatedCopied: { en: 'Statement link created and copied', ar: 'تم إنشاء رابط الكشف ونسخه' },
  statementLinkCreateFailed: { en: 'Could not create statement link', ar: 'تعذر إنشاء رابط الكشف' },
