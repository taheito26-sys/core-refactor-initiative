...
const translations = {
  ...
  otcP2pTrading:            { en: 'P2P Trading',                                ar: 'تداول P2P' },
  otcBuySellSubtitle:       { en: 'Buy and sell USDT directly with merchants',  ar: 'شراء وبيع USDT مباشرة مع التجار' },
  otcPostAd:                { en: 'Post Ad',                                    ar: 'نشر إعلان' },
  otcPost:                  { en: 'Post',                                       ar: 'نشر' },
  otcCashAds:               { en: 'Cash Ads',                                   ar: 'إعلانات النقد' },
  otcUsdtAds:               { en: 'USDT Ads',                                   ar: 'إعلانات USDT' },
  otcMerchants:             { en: 'Merchants',                                  ar: 'التجار' },
  otcActiveTrades:          { en: 'Active Trades',                              ar: 'الصفقات النشطة' },
  otcP2p:                   { en: 'P2P',                                        ar: 'P2P' },
  otcMyAds:                 { en: 'My Ads',                                     ar: 'إعلاناتي' },
  otcOrders:                { en: 'Orders',                                     ar: 'الطلبات' },
  otcStats:                 { en: 'Stats',                                      ar: 'الإحصائيات' },
  otcBuyUsdt:               { en: 'Buy USDT',                                   ar: 'شراء USDT' },
  otcSellUsdt:              { en: 'Sell USDT',                                  ar: 'بيع USDT' },
  otcCurrency:              { en: 'Currency',                                   ar: 'العملة' },
  otcAll:                   { en: 'All',                                        ar: 'الكل' },
  otcFilter:                { en: 'Filter',                                     ar: 'تصفية' },
  otcAdvancedFilters:       { en: 'Advanced Filters',                           ar: 'تصفية متقدمة' },
  otcPaymentMethod:         { en: 'Payment Method',                             ar: 'طريقة الدفع' },
  otcAllMethods:            { en: 'All Methods',                                ar: 'كل الطرق' },
  otcAmountRange:           { en: 'Amount Range',                               ar: 'نطاق المبلغ' },
  otcRateRange:             { en: 'Rate Range',                                 ar: 'نطاق السعر' },
  otcMerchantTrustTier:     { en: 'Merchant Trust Tier',                        ar: 'مستوى ثقة التاجر' },
  otcAllTiers:              { en: 'All Tiers',                                  ar: 'كل المستويات' },
  otcVerified:              { en: 'Verified',                                   ar: 'موثق' },
  otcTrusted:               { en: 'Trusted',                                    ar: 'موثوق' },
  otcNew:                   { en: 'New',                                        ar: 'جديد' },
  otcMinCompletionRate:     { en: 'Min Completion Rate',                        ar: 'أدنى معدل إتمام' },
  otcClearAllFilters:       { en: 'Clear All Filters',                          ar: 'مسح كل الفلاتر' },
  otcSellersAvailable:      { en: 'sellers available',                          ar: 'بائعين متاحين' },
  otcBuyersAvailable:       { en: 'buyers available',                           ar: 'مشترين متاحين' },
  otcNoSellersMatch:        { en: 'No sellers match your filters.',             ar: 'لا يوجد بائعون يطابقون الفلاتر.' },
  otcNoBuyersMatch:         { en: 'No buyers match your filters.',              ar: 'لا يوجد مشترون يطابقون الفلاتر.' },
  otcNoAdsYet:              { en: "You haven't posted any ads yet.",             ar: 'لم تنشر أي إعلانات بعد.' },
  otcActive:                { en: 'active',                                     ar: 'نشط' },
  otcCompleted:             { en: 'completed',                                  ar: 'مكتمل' },
  otcNoOrdersFound:         { en: 'No orders found.',                           ar: 'لا توجد طلبات.' },
  otcLimit:                 { en: 'Limit',                                      ar: 'الحد' },
  otcBuy:                   { en: 'Buy',                                        ar: 'شراء' },
  otcSell:                  { en: 'Sell',                                       ar: 'بيع' },
  otcCash:                  { en: 'Cash',                                       ar: 'نقد' },
  otcUsdt:                  { en: 'USDT',                                       ar: 'USDT' },
  otcAccept:                { en: 'Accept',                                     ar: 'قبول' },
  otcCounter:               { en: 'Counter',                                    ar: 'عرض مضاد' },
  otcComplete:              { en: 'Complete',                                   ar: 'إتمام' },
  otcChat:                  { en: 'Chat',                                       ar: 'محادثة' },
  otcCancel:                { en: 'Cancel',                                     ar: 'إلغاء' },
  otcDispute:               { en: 'Dispute',                                    ar: 'نزاع' },
  otcReview:                { en: 'Review',                                     ar: 'تقييم' },
  otcOffered:               { en: 'Offered',                                    ar: 'معروض' },
  otcConfirmed:             { en: 'Confirmed',                                  ar: 'مؤكد' },
  otcEscrowed:              { en: 'Escrowed',                                   ar: 'ضمان' },
  otcEscrowProtection:      { en: 'Escrow Protection',                          ar: 'حماية الضمان' },
  otcBothDeposited:         { en: 'Both Deposited',                             ar: 'الطرفان أودعا' },
  otcPartial:               { en: 'Partial',                                    ar: 'جزئي' },
  otcNotStarted:            { en: 'Not Started',                                ar: 'لم يبدأ' },
  otcYouDeposit:            { en: 'You deposit',                                ar: 'إيداعك' },
  otcCounterpartyDeposits:  { en: 'Counterparty deposits',                      ar: 'إيداع الطرف الآخر' },
  otcViewEscrowDetails:     { en: 'View Escrow Details',                        ar: 'عرض تفاصيل الضمان' },
  otcViewCompleteEscrow:    { en: 'View & Complete Escrow',                     ar: 'عرض وإتمام الضمان' },
  otcOpenEscrow:            { en: 'Open Escrow',                                ar: 'فتح الضمان' },
  otcEscrowProgress:        { en: 'Escrow Progress',                            ar: 'تقدم الضمان' },
  otcDeposits:              { en: 'deposits',                                   ar: 'إيداعات' },
  otcTradeAmount:           { en: 'Trade Amount',                               ar: 'مبلغ الصفقة' },
  otcCounterparty:          { en: 'Counterparty',                               ar: 'الطرف الآخر' },
  otcYourDeposit:           { en: 'Your Deposit',                               ar: 'إيداعك' },
  otcLocked:                { en: 'Locked',                                     ar: 'مقفل' },
  otcPending:               { en: 'Pending',                                    ar: 'قيد الانتظار' },
  otcWaiting:               { en: 'Waiting',                                    ar: 'بانتظار' },
  otcBothDepositedSafe:     { en: 'Both parties deposited — trade can be completed safely', ar: 'كلا الطرفين أودع — يمكن إتمام الصفقة بأمان' },
  otcPaymentProof:          { en: 'Payment Proof (optional)',                    ar: 'إثبات الدفع (اختياري)' },
  otcProofAttached:         { en: 'Proof attached',                             ar: 'تم إرفاق الإثبات' },
  otcRemove:                { en: 'Remove',                                     ar: 'إزالة' },
  otcUploadProof:           { en: 'Upload screenshot or receipt',               ar: 'ارفع لقطة شاشة أو إيصال' },
  otcDepositToEscrow:       { en: 'Deposit to Escrow',                          ar: 'إيداع في الضمان' },
  otcEscrowLocked:          { en: 'Your escrow is locked.',                     ar: 'تم قفل الضمان الخاص بك.' },
  otcReadyComplete:         { en: 'Ready to complete trade.',                   ar: 'جاهز لإتمام الصفقة.' },
  otcWaitingCounterparty:   { en: 'Waiting for counterparty deposit.',          ar: 'بانتظار إيداع الطرف الآخر.' },
  otcPostNewAd:             { en: 'Post New Ad',                                ar: 'نشر إعلان جديد' },
  otcIHaveCash:             { en: 'I have Cash',                                ar: 'لدي نقد' },
  otcIHaveUsdt:             { en: 'I have USDT',                                ar: 'لدي USDT' },
  otcMinAmount:             { en: 'Min amount',                                 ar: 'أقل مبلغ' },
  otcMaxAmount:             { en: 'Max amount',                                 ar: 'أعلى مبلغ' },
  otcRate:                  { en: 'Rate',                                       ar: 'السعر' },
  otcPaymentMethods:        { en: 'Payment Methods',                            ar: 'طرق الدفع' },
  otcNote:                  { en: 'Note (optional)',                             ar: 'ملاحظة (اختياري)' },
  otcUseMarketRate:         { en: 'Use P2P market rate',                        ar: 'استخدم سعر السوق P2P' },
  otcFillFields:            { en: 'Fill all required fields',                   ar: 'املأ جميع الحقول المطلوبة' },
  otcTradeWith:             { en: 'Trade with',                                 ar: 'تداول مع' },
  otcAd:                    { en: 'Ad',                                         ar: 'إعلان' },
  otcMerchant:              { en: 'Merchant',                                   ar: 'تاجر' },
  otcAmount:                { en: 'Amount',                                     ar: 'المبلغ' },
  otcSendOffer:             { en: 'Send Offer',                                 ar: 'إرسال عرض' },
  otcEnterAmount:           { en: 'Enter an amount',                            ar: 'أدخل مبلغ' },
  otcCounterOffer:          { en: 'Counter Offer',                              ar: 'عرض مضاد' },
  otcOriginal:              { en: 'Original',                                   ar: 'الأصلي' },
  otcCounterAmount:         { en: 'Counter amount',                             ar: 'مبلغ مضاد' },
  otcCounterRate:           { en: 'Counter rate',                               ar: 'سعر مضاد' },
  otcSendCounter:           { en: 'Send Counter',                               ar: 'إرسال عرض مضاد' },
  otcReviewTrade:           { en: 'Review Trade',                               ar: 'تقييم الصفقة' },
  otcRateExperience:        { en: 'Rate your experience with',                  ar: 'قيّم تجربتك مع' },
  otcShareExperience:       { en: 'Share your experience (optional)',            ar: 'شارك تجربتك (اختياري)' },
  otcSubmitReview:          { en: 'Submit Review',                               ar: 'إرسال التقييم' },
  otcOpenDispute:           { en: 'Open Dispute',                                ar: 'فتح نزاع' },
  otcTradeWithLabel:        { en: 'Trade with:',                                ar: 'صفقة مع:' },
  otcAmountLabel:           { en: 'Amount:',                                    ar: 'المبلغ:' },
  otcStatusLabel:           { en: 'Status:',                                    ar: 'الحالة:' },
  otcDisputeWarning:        { en: 'Disputes are reviewed by platform moderators. Please provide detailed info.', ar: 'يتم مراجعة النزاعات من قبل مشرفي المنصة. يرجى تقديم معلومات تفصيلية.' },
  otcDescribeIssue:         { en: 'Describe the issue in detail...',             ar: 'صف المشكلة بالتفصيل...' },
  otcFileDispute:           { en: 'File Dispute',                                ar: 'تقديم نزاع' },
  otcCompletedLabel:        { en: 'Completed',                                   ar: 'مكتمل' },
  otcVolume:                { en: 'Volume',                                      ar: 'الحجم' },
  otcSuccessRate:           { en: 'Success Rate',                                ar: 'معدل النجاح' },
  otcDisputes:              { en: 'Disputes',                                    ar: 'النزاعات' },
  otcLiveP2pRate:           { en: 'Live P2P Rate (QAR)',                         ar: 'سعر P2P المباشر (QAR)' },
  otcVolumeByCurrency:      { en: 'Volume by Currency',                          ar: 'الحجم حسب العملة' },
  otcTrades:                { en: 'trades',                                      ar: 'صفقات' },
  otcTopCounterparties:     { en: 'Top Counterparties',                          ar: 'أبرز الأطراف المقابلة' },
  otcRecentDisputes:        { en: 'Recent Disputes',                             ar: 'نزاعات حديثة' },
  otcResolution:            { en: 'Resolution',                                  ar: 'الحل' },
  otcMarketDepth:           { en: 'Market Depth by Currency',                    ar: 'عمق السوق حسب العملة' },
  otcAvgRate:               { en: 'Avg rate',                                    ar: 'متوسط السعر' },
  otcAds:                   { en: 'ads',                                         ar: 'إعلانات' },
  otcMin:                   { en: 'Min',                                         ar: 'أدنى' },
  otcMax:                   { en: 'Max',                                         ar: 'أقصى' },
  otcMinRate:               { en: 'Min rate',                                    ar: 'أدنى سعر' },
  otcMaxRate:               { en: 'Max rate',                                    ar: 'أقصى سعر' },
  otcNoMethods:             { en: 'No methods',                                  ar: 'لا توجد طرق' },
  otcAdPaused:              { en: 'Ad paused',                                   ar: 'تم إيقاف الإعلان' },
  otcAdActivated:           { en: 'Ad activated',                                ar: 'تم تفعيل الإعلان' },
  otcAdRemoved:             { en: 'Ad removed',                                  ar: 'تم حذف الإعلان' },
  otcAdPosted:              { en: 'Ad posted!',                                  ar: 'تم نشر الإعلان!' },
  otcOfferSent:             { en: 'Offer sent!',                                 ar: 'تم إرسال العرض!' },
  otcCounterSent:           { en: 'Counter offer sent!',                         ar: 'تم إرسال العرض المضاد!' },
  otcTradeConfirmed:        { en: 'Trade confirmed!',                            ar: 'تم تأكيد الصفقة!' },
  otcTradeCompleted:        { en: 'Trade completed!',                            ar: 'تم إتمام الصفقة!' },
  otcTradeCancelled:        { en: 'Trade cancelled',                             ar: 'تم إلغاء الصفقة' },
  otcReviewSubmitted:       { en: 'Review submitted!',                           ar: 'تم إرسال التقييم!' },
  otcDisputeFiled:          { en: 'Dispute filed',                               ar: 'تم تقديم النزاع' },
  otcEscrowDeposited:       { en: 'Escrow deposited!',                           ar: 'تم إيداع الضمان!' },
  otcSearch:                { en: 'Search...',                                   ar: 'بحث...' },
  otcJustNow:               { en: 'just now',                                    ar: 'الآن' },
  otcPosting:               { en: 'Posting...',                                  ar: 'جارٍ النشر...' },
  otcDefault:               { en: 'default',                                     ar: 'افتراضي' },
  otcTotal:                 { en: 'Total',                                       ar: 'الإجمالي' },

  // ── Customer portal ──
  customer: { en: 'Customer', ar: 'عميل' },
  customerDashboard: { en: 'Customer Dashboard', ar: 'لوحة العميل' },
  customerDashboardSubtitle: { en: 'Track your deals, payouts, and corridor activity in one place.', ar: 'تابع الصفقات والمدفوعات وحركة المسارات في مكان واحد.' },
  customerPortalScope: { en: 'Customer Scope', ar: 'نطاق العميل' },
  customerSettingsTitle: { en: 'Settings', ar: 'الإعدادات' },
  customerAccount: { en: 'Account', ar: 'الحساب' },
  customerProfileLabel: { en: 'Profile', ar: 'الملف الشخصي' },
  customerPreferredCurrency: { en: 'Preferred Currency', ar: 'العملة المفضلة' },
  customerSelectCountry: { en: 'Select country', ar: 'اختر البلد' },
  customerDisplayNameRequired: { en: 'Display name is required.', ar: 'الاسم المعروض مطلوب.' },
  customerCountryRequired: { en: 'Country is required.', ar: 'البلد مطلوب.' },
  customerProfileUpdated: { en: 'Profile updated.', ar: 'تم تحديث الملف الشخصي.' },
  customerSaveFailed: { en: 'Failed to save.', ar: 'فشل الحفظ.' },
  customerSetupTitle: { en: 'Set Up Your Profile', ar: 'إعداد ملفك الشخصي' },
  customerSetupDesc: { en: 'Tell us a bit about yourself to get started.', ar: 'أخبرنا قليلاً عن نفسك للبدء.' },
  customerWelcomeReady: { en: 'Welcome! Your account is ready.', ar: 'مرحباً! حسابك جاهز.' },
  customerSignupTitle: { en: 'Create Account', ar: 'إنشاء حساب' },
  customerSignupDesc: { en: 'Join the TRACKER platform', ar: 'انضم إلى منصة TRACKER' },
  customerCreateAccount: { en: 'Create Account', ar: 'إنشاء حساب' },
  customerRoleLabel: { en: 'I am a', ar: 'أنا' },
  or: { en: 'or', ar: 'أو' },
  customerMerchantRoleTitle: { en: 'Merchant', ar: 'تاجر' },
  customerMerchantRoleDesc: { en: 'Trade & manage stock', ar: 'تداول وأدر المخزون' },
  customerCustomerRoleTitle: { en: 'Customer', ar: 'عميل' },
  customerCustomerRoleDesc: { en: 'Buy & sell with merchants', ar: 'اشترِ وبِع مع التجار' },
  customerSelectCountryPrompt: { en: 'Select your country', ar: 'اختر بلدك' },
  customerPasswordsMismatch: { en: 'Passwords do not match.', ar: 'كلمات المرور غير متطابقة.' },
  customerPasswordTooShort: { en: 'Password must be at least 8 characters.', ar: 'يجب أن تكون كلمة المرور 8 أحرف على الأقل.' },
  customerSignupSuccess: { en: 'Account created! Please check your email to verify your account.', ar: 'تم إنشاء الحساب! يرجى التحقق من بريدك الإلكتروني لتأكيد الحساب.' },
  customerSignupFailed: { en: 'Signup failed.', ar: 'فشل التسجيل.' },
  customerAlreadyHaveAccount: { en: 'Already have an account?', ar: 'هل لديك حساب بالفعل؟' },
  customerSignIn: { en: 'Sign in', ar: 'تسجيل الدخول' },
  customerEmail: { en: 'Email', ar: 'البريد الإلكتروني' },
  customerPassword: { en: 'Password', ar: 'كلمة المرور' },
  customerConfirmPassword: { en: 'Confirm Password', ar: 'تأكيد كلمة المرور' },
  customerDashboardScopeNote: { en: 'This dashboard only shows your own data.', ar: 'تُعرض بياناتك أنت فقط في هذه اللوحة.' },
  loggedInCustomerOnly: { en: 'Logged-in customer only', ar: 'للعميل المسجل فقط' },
  totalDeals: { en: 'Total Deals', ar: 'إجمالي الصفقات' },
  totalCash: { en: 'Total Cash', ar: 'إجمالي النقد' },
  historicalTotalSent: { en: 'Historical Total Sent', ar: 'إجمالي المرسَل تاريخياً' },
  historicalTotalReceived: { en: 'Historical Total Received', ar: 'إجمالي المستلَم تاريخياً' },
  completedOrdersOnly: { en: 'Completed orders only', ar: 'الطلبات المكتملة فقط' },
  cashByCurrency: { en: 'Cash by Currency', ar: 'النقد حسب العملة' },
  currencies: { en: 'Currencies', ar: 'العملات' },
  noCashHistory: { en: 'No cash history yet.', ar: 'لا يوجد سجل نقدي بعد.' },
  payoutHistory: { en: 'Payout History', ar: 'سجل المدفوعات' },
  noPayoutHistory: { en: 'No payout history yet.', ar: 'لا يوجد سجل مدفوعات بعد.' },
  rateHistory: { en: 'Rate History', ar: 'سجل الأسعار' },
  noRateHistory: { en: 'No rate history yet.', ar: 'لا يوجد سجل أسعار بعد.' },
  customerNotifications: { en: 'Notifications', ar: 'الإشعارات' },
  customerNotificationsSubtitle: { en: 'Customer-only in-app alerts and updates.', ar: 'تنبيهات وتحديثات داخلية خاصة بالعميل فقط.' },
  noDetails: { en: 'No details available.', ar: 'لا توجد تفاصيل متاحة.' },
  noDataAvailable: { en: 'No data available.', ar: 'لا توجد بيانات متاحة.' },
  read: { en: 'Read', ar: 'مقروء' },
  corridorSupport: { en: 'Corridor Support', ar: 'المسارات المدعومة' },
  rails: { en: 'Rails', ar: 'القنوات' },
  noRailsAvailable: { en: 'No payout rails available for this corridor.', ar: 'لا توجد قنوات دفع متاحة لهذا المسار.' },
  bankTransfer: { en: 'Bank Transfer', ar: 'تحويل بنكي' },
  cashPickup: { en: 'Cash Pickup', ar: 'استلام نقدي' },
  mobileWallet: { en: 'Mobile Wallet', ar: 'محفظة موبايل' },
  instantBank: { en: 'Instant Bank', ar: 'تحويل فوري' },
  cardPayout: { en: 'Card Payout', ar: 'دفع بالبطاقة' },
  selectRail: { en: 'Select a payout rail', ar: 'اختر قناة الدفع' },
  railsFilteredByCorridor: { en: 'Only corridor-compatible rails are shown.', ar: 'تُعرض فقط القنوات المتوافقة مع المسار.' },
  ...
  connectMerchantPrompt: { en: 'Connect a merchant to place an order.', ar: 'قم بربط تاجر لإنشاء طلب.' },
  customerOrdersSubtitle: { en: 'Create orders, track corridors, and review your activity.', ar: 'أنشئ الطلبات وتابع المسارات وراجع نشاطك.' },
  merchantSearchPlaceholder: { en: 'Enter Merchant ID or Code...', ar: 'أدخل رقم التاجر أو الرمز...' },
  merchantSearchHelp: { en: 'Search by Merchant ID or Code above to get started.', ar: 'ابحث برقم التاجر أو الرمز بالأعلى للبدء.' },
  noMerchantsConnected: { en: 'No merchants connected yet.', ar: 'لا يوجد تجار مرتبطون بعد.' },
  connectionSent: { en: 'Connection request sent!', ar: 'تم إرسال طلب الربط!' },
  connectFailed: { en: 'Failed to connect.', ar: 'فشل الربط.' },
  updatePreferredFailed: { en: 'Failed to update preference.', ar: 'فشل تحديث التفضيل.' },
  metricsLoadFailed: { en: 'Could not load metrics.', ar: 'تعذر تحميل المؤشرات.' },
  sendCountry: { en: 'Send Country', ar: 'بلد الإرسال' },
  receiveCountry: { en: 'Receive Country', ar: 'بلد الاستلام' },
  sendCurrency: { en: 'Send Currency', ar: 'عملة الإرسال' },
  receiveCurrency: { en: 'Receive Currency', ar: 'عملة الاستلام' },
  payoutRail: { en: 'Payout Rail', ar: 'قناة الدفع' },
  corridorLabel: { en: 'Corridor Label', ar: 'اسم المسار' },
  ...
  corridorCard: { en: 'Corridor Card', ar: 'بطاقة المسار' },
  uploadPaymentProof: { en: 'Upload payment proof (image or PDF)', ar: 'ارفع إثبات الدفع (صورة أو PDF)' },
  uploading: { en: 'Uploading...', ar: 'جارٍ الرفع...' },
  chooseFile: { en: 'Choose File', ar: 'اختر ملفاً' },
  proofUploaded: { en: 'Payment proof uploaded', ar: 'تم رفع إثبات الدفع' },
  uploadFailed: { en: 'Upload failed.', ar: 'فشل الرفع.' },
  uploadImagesOrPdf: { en: 'Only images and PDF files are allowed.', ar: 'يسمح بالصور وملفات PDF فقط.' },
  fileTooLarge: { en: 'File must be under 5 MB.', ar: 'يجب ألا يتجاوز الملف 5 ميغابايت.' },
  cancelOrder: { en: 'Cancel order', ar: 'إلغاء الطلب' },
  cancelFailed: { en: 'Cancel failed.', ar: 'فشل الإلغاء.' },
  confirmationExpired: { en: 'Merchant confirmation expired', ar: 'انتهت مهلة تأكيد التاجر' },
  merchantConfirmIn: { en: 'Merchant must confirm in', ar: 'يجب على التاجر التأكيد خلال' },
  orderNotFound: { en: 'Order not found.', ar: 'الطلب غير موجود.' },
  accessDenied: { en: 'Access denied.', ar: 'تم رفض الوصول.' },
  customerMerchants: { en: 'Merchants', ar: 'التجار' },
  customerWalletSubtitle: { en: 'Completed payouts and rate history from your own orders.', ar: 'المدفوعات المكتملة وسجل الأسعار من طلباتك أنت.' },
  ...
  kpiNetProfitShort: { en: 'PROFIT', ar: 'الربح' },
  kpiAvgCostShort: { en: 'AVG COST', ar: 'متوسط التكلفة' },
  avgMargin: { en: 'AVG MARGIN', ar: 'متوسط الهامش' },
  loansUnpaid: { en: 'UNPAID', ar: 'غير مسدد' },
  ...
  cashAvailable: { en: 'CASH', ar: 'النقد' },
  ...
  myNetProfit: { en: 'My Net Profit', ar: 'صافي ربحي' },
  ownOrdersLabel: { en: 'Own Orders', ar: 'طلباتي' },
  ...
  p2pSellAvgTop10: { en: 'SELL AVG (TOP 20)', ar: 'متوسط البيع (أفضل 20)' },
  p2pSellAvgTop20: { en: 'SELL AVG (TOP 20)', ar: 'متوسط البيع (أفضل 20)' },
  ...
  p2pNoRangeYet: { en: 'No intraday range yet', ar: 'لا يوجد نطاق يومي بعد' },
  ...
  p2pSellAvgTop10Label: { en: 'Sell Avg (Top 20)', ar: 'متوسط البيع (أفضل 20)' },
  p2pSellAvgTop20Label: { en: 'Sell Avg (Top 20)', ar: 'متوسط البيع (أفضل 20)' },
  ...
  p2pWaitingFirstSync: { en: 'Waiting for first sync...', ar: 'بانتظار المزامنة الأولى...' },
  p2pSync5Min: { en: 'Sync · 5 min', ar: 'مزامنة · 5 دقائق' },
  p2pCollectingData: { en: 'Collecting data for {market}...', ar: 'جاري جمع البيانات لـ {market}...' },
  p2pSyncHint: { en: 'The backend sync runs every 5 minutes. First data point will appear automatically — no refresh needed.', ar: 'تعمل المزامنة الخلفية كل 5 دقائق. ستظهر أول نقطة بيانات تلقائياً - لا حاجة للتحديث.' },
  p2pRoundTripSpread: { en: 'Round-Trip Spread', ar: 'فارق الرحلة الكاملة' },
  p2pSim: { en: 'sim', ar: 'محاكاة' },
  p2pTrend24h: { en: '24h Trend', ar: 'اتجاه 24 ساعة' },
  p2pJustNow: { en: 'just now', ar: 'الآن' },
  p2pMinAgo: { en: '{n} min ago', ar: 'منذ {n} دقيقة' },
  p2pHAgo: { en: '{n}h ago', ar: 'منذ {n} ساعة' },
  p2pMerchantDepthStats: { en: 'Merchant Depth Stats (24h)', ar: 'إحصائيات عمق التجار (24 ساعة)' },
  p2pTracked: { en: 'tracked', ar: 'مُتتبع' },
  p2pTop5Available: { en: 'Top 5 Always Available', ar: 'أفضل 5 متاحين دائماً' },
  p2pTop5Qty: { en: 'Top 5 Biggest USDT Qty', ar: 'أفضل 5 من حيث كمية USDT' },
  ...
  exportNoOrders: { en: 'No orders to export', ar: 'لا توجد طلبات للتصدير' },
  exportPrintUnavailable: { en: 'Print isn’t available here — downloaded the spreadsheet instead.', ar: 'الطباعة غير متاحة هنا — تم تنزيل جدول البيانات بدلاً من ذلك.' },
  ordersReportTitle: { en: 'Orders Report', ar: 'تقرير الطلبات' },
  ordersReportAllPeriod: { en: 'All time', ar: 'كل الفترات' },
  ordersReportTotalOrders: { en: 'Total Orders', ar: 'إجمالي الطلبات' },
  ordersReportTotalSoldUsdt: { en: 'Total Sold USDT', ar: 'إجمالي المباع USDT' },
  ordersReportTotalQar: { en: 'Total QAR', ar: 'إجمالي القطري' },
  ordersReportTotalCost: { en: 'Total Cost', ar: 'إجمالي التكلفة' },
  ordersReportTotalNetProfit: { en: 'Total Net Profit', ar: 'صافي الربح الإجمالي' },
  ordersReportOrderDetail: { en: 'Order Detail', ar: 'تفاصيل الطلبات' },
  ordersReportColSell: { en: 'Sell Price', ar: 'سعر البيع' },
  ordersReportColQty: { en: 'Qty USDT', ar: 'الكمية USDT' },
  ordersReportColCost: { en: 'Cost', ar: 'التكلفة' },
  ordersReportColNet: { en: 'Net', ar: 'الصافي' },
  ordersReportColBuyRate: { en: 'Buy Rate', ar: 'سعر الشراء' },
  ordersReportColMargin: { en: 'Margin %', ar: 'الهامش %' },
  ordersReportColSource: { en: 'Source', ar: 'المصدر' },
  ordersReportFooter: { en: 'Generated from Cash Management / Orders', ar: 'تم إنشاؤه من إدارة النقد / الطلبات' },
  ...
  entryModeUsdtEgp: { en: '📦 USDT + EGP', ar: '📦 USDT + ج.م' },
  entryModeUsdtPrice: { en: '📊 USDT + Price', ar: '📊 USDT + السعر' },
  entryModeUsdtMarkup: { en: '％ USDT + Markup', ar: '％ USDT + هامش' },
  markupPctLabel: { en: 'Markup % over cost', ar: 'نسبة الهامش % فوق التكلفة' },
  markupCostLabel: { en: 'Cost', ar: 'التكلفة' },
  markupSellLabel: { en: 'sell price', ar: 'سعر البيع' },
  markupNetLabel: { en: 'Net profit', ar: 'صافي الربح' },
  markupNotEnoughStock: { en: 'Not enough stock to price this quantity from cost — lower the quantity or use Manual cost.', ar: 'المخزون لا يكفي لتسعير هذه الكمية من التكلفة — قلّل الكمية أو استخدم التكلفة اليدوية.' },
  ...
  autoCalcTotalEgp: { en: 'Auto Total EGP', ar: 'إجمالي ج.م التلقائي' },
  ...
  monthAvgBuyPrice: { en: 'Avg Buy Price (Month)', ar: 'متوسط سعر الشراء (الشهر)' },
  checkExchangeReconciliation: { en: 'Check tracker vs. exchange balances', ar: 'مطابقة المتتبع مع أرصدة المنصات' },
  ...
  reconcileExplainedStatus: { en: 'Unregistered orders', ar: 'طلبات غير مسجلة' },
  reconcilePendingHeader: { en: '{count} Binance/OKX record(s) not registered yet account for {amount} USDT of this delta:', ar: '{count} سجل من Binance/OKX غير مسجل بعد يفسر {amount} USDT من هذا الفرق:' },
  reconcileFullyExplained: { en: 'That covers the whole delta — register these (or tag them as borrow / lend) and the tracker will match. No batch needs fixing.', ar: 'هذا يغطي الفرق بالكامل — سجّلها (أو علّمها كاقتراض / إقراض) وسيتطابق المتتبع. لا حاجة لتعديل أي دفعة.' },
  reconcileResidual: { en: 'After registering them, the remaining mismatch is {amount} USDT — only that part needs fixing below.', ar: 'بعد تسجيلها، يبقى فرق قدره {amount} USDT — هذا الجزء فقط يحتاج إلى تصحيح أدناه.' },
  reconcileSell: { en: 'sell', ar: 'بيع' },
  reconcileBuy: { en: 'buy', ar: 'شراء' },
  reconcileSent: { en: 'sent', ar: 'مُرسل' },
  reconcileReceived: { en: 'received', ar: 'مستلم' },
  reconcileMore: { en: 'more', ar: 'أخرى' },
  ...
  reconciliationFixWithBatches: { en: 'Fix with batches', ar: 'تصحيح باستخدام الدفعات' },
  reconciliationFixHint: { en: 'Check off which batches are overstated and trim each one — the amount auto-fills up to what still needs to come off.', ar: 'حدّد الدفعات المبالغ في قيمتها وقلّص كل واحدة — سيُملأ المبلغ تلقائيًا حتى المتبقي المطلوب خصمه.' },
  reconciliationTargetLbl: { en: 'Needs to come down by', ar: 'يحتاج إلى تخفيض بمقدار' },
  ...
  fastestSupplierLbl: { en: 'Fastest-turnover supplier', ar: 'المورد الأسرع دوراناً' },
  lowStockAlertLbl: { en: 'Low stock — consider restocking', ar: 'مخزون منخفض — فكر في إعادة التزويد' },
  ...
  // ── Merchant USDT loans ──
  mloanTab: { en: 'Loans', ar: 'القروض' },
  mloanTitle: { en: 'Merchant loan', ar: 'قرض تاجر' },
  mloanPanelTitle: { en: 'USDT loans with merchants', ar: 'قروض USDT مع التجار' },
  mloanPanelHint: { en: 'Tag any USDT you received from or sent to a merchant as a loan — just pick the merchant. The app works out if it\'s a borrow, a repayment, a loan out or money coming back, keeps it out of sales and profit, and keeps a running balance per merchant.', ar: 'علّم أي USDT استلمته من تاجر أو أرسلته له كقرض — فقط اختر التاجر. يحدد التطبيق إن كان اقتراضًا أو سدادًا أو إقراضًا أو استردادًا، ويستبعده من المبيعات والأرباح، ويحفظ رصيدًا جاريًا لكل تاجر.' },
  mloanNeedsDecision: { en: 'Needs a decision', ar: 'بحاجة إلى قرار' },
  mloanNeedsDecisionHint: { en: 'Binance / OKX records not in the tracker yet. Give each one an answer: sale, purchase, merchant loan or ignore.', ar: 'سجلات Binance / OKX غير المسجلة بعد. حدد لكل منها: بيع، شراء، قرض تاجر أو تجاهل.' },
  mloanAllDecided: { en: 'Everything from your exchanges is registered ✓', ar: 'كل ما في منصاتك مسجل ✓' },
  mloanItsSale: { en: 'It\'s a sale', ar: 'بيع' },
  mloanItsPurchase: { en: 'It\'s a purchase', ar: 'شراء' },
  mloanItsLoan: { en: 'Merchant loan', ar: 'قرض تاجر' },
  mloanIgnore: { en: 'Ignore', ar: 'تجاهل' },
  mloanSelect: { en: 'Select', ar: 'تحديد' },
  mloanSelected: { en: 'selected', ar: 'محدد' },
  mloanShowMore: { en: 'Show more', ar: 'عرض المزيد' },
  mloanMerchants: { en: 'Merchants', ar: 'التجار' },
  mloanManualEntry: { en: 'Record by hand', ar: 'تسجيل يدوي' },
  mloanNoOpen: { en: 'No open loans.', ar: 'لا توجد قروض مفتوحة.' },
  mloanSettledGroup: { en: 'Settled', ar: 'مسددة' },
  mloanMoves: { en: 'moves', ar: 'حركات' },
  mloanAddMove: { en: 'Add a move by hand', ar: 'إضافة حركة يدويًا' },
  mloanKindBorrowed: { en: 'Borrowed', ar: 'اقترضت' },
  mloanKindRepaid: { en: 'Repaid', ar: 'سددت' },
  mloanKindLent: { en: 'Lent', ar: 'أقرضت' },
  mloanKindReturned: { en: 'Returned to you', ar: 'أُعيد إليك' },
  mloanCost: { en: 'cost', ar: 'التكلفة' },
  mloanEstCost: { en: 'estimated cost until repaid', ar: 'تكلفة تقديرية حتى السداد' },
  mloanUndo: { en: 'Undo', ar: 'تراجع' },
  mloanUndoConfirm: { en: 'Undo this move? The record goes back to what it was before (order, batch or exchange record) and balances are recalculated.', ar: 'التراجع عن هذه الحركة؟ يعود السجل كما كان (طلب أو دفعة أو سجل منصة) وتُعاد حسابات الأرصدة.' },
  mloanUndone: { en: 'Move undone', ar: 'تم التراجع' },
  mloanSaved: { en: 'Loan recorded', ar: 'تم تسجيل القرض' },
  mloanSaveFailed: { en: 'Could not save — try again', ar: 'تعذر الحفظ — حاول مرة أخرى' },
  mloanTransfer: { en: 'transfer', ar: 'تحويل' },
  mloanFromBatch: { en: 'stock batch', ar: 'دفعة مخزون' },
  mloanFromOrder: { en: 'order', ar: 'طلب' },
  mloanReceived: { en: 'Received', ar: 'استلمت' },
  mloanSent: { en: 'Sent', ar: 'أرسلت' },
  mloanIReceived: { en: 'I received', ar: 'استلمت' },
  mloanISent: { en: 'I sent', ar: 'أرسلت' },
  mloanAmount: { en: 'USDT amount', ar: 'كمية USDT' },
  mloanMoreRecords: { en: 'more records', ar: 'سجلات أخرى' },
  mloanWhichMerchant: { en: 'Which merchant?', ar: 'أي تاجر؟' },
  mloanMerchantPlaceholder: { en: 'Search or type a merchant name', ar: 'ابحث أو اكتب اسم التاجر' },
  mloanConnected: { en: 'connected', ar: 'متصل' },
  mloanSettledShort: { en: 'settled', ar: 'مسدد' },
  mloanYouOweShort: { en: 'you owe', ar: 'عليك' },
  mloanOwesYouShort: { en: 'owes you', ar: 'لك' },
  mloanOnlyPart: { en: 'Only part of it?', ar: 'جزء منه فقط؟' },
  mloanPartHint: { en: 'The rest stays in the list to register as a normal sale or purchase.', ar: 'الباقي يبقى في القائمة لتسجيله كبيع أو شراء عادي.' },
  mloanPreviewBorrow: { en: 'Borrowed {amount} from {name}', ar: 'اقترضت {amount} من {name}' },
  mloanPreviewReturn: { en: '{name} returned {amount} they owed you', ar: 'أعاد {name} مبلغ {amount} كان عليه لك' },
  mloanPreviewRepay: { en: 'Repaid {amount} of what you owe {name}', ar: 'سددت {amount} مما عليك لـ {name}' },
  mloanPreviewLend: { en: 'Lent {amount} to {name}', ar: 'أقرضت {amount} لـ {name}' },
  mloanAfterThis: { en: 'After this:', ar: 'بعد ذلك:' },
  mloanBalanceIOwe: { en: 'you owe {name} {amount}', ar: 'عليك لـ {name} {amount}' },
  mloanBalanceOwesMe: { en: '{name} owes you {amount}', ar: '{name} عليه لك {amount}' },
  mloanBalanceSettled: { en: 'settled with {name} ✓', ar: 'مسدد مع {name} ✓' },
  mloanStock: { en: 'Stock', ar: 'المخزون' },
  mloanNoProfit: { en: 'not a sale or purchase — no profit', ar: 'ليس بيعًا ولا شراءً — بدون ربح' },
  mloanConfirm: { en: 'Confirm', ar: 'تأكيد' },
  mloanErrName: { en: 'Pick or type the merchant', ar: 'اختر أو اكتب اسم التاجر' },
  mloanErrAmount: { en: 'Check the amount', ar: 'تحقق من الكمية' },
  mloanErrLinked: { en: 'This order is linked to a merchant deal — cancel it on the Orders page first', ar: 'هذا الطلب مرتبط بصفقة تاجر — ألغِه من صفحة الطلبات أولًا' },
  mloanInboxButton: { en: 'Merchant loan — not a sale or purchase', ar: 'قرض تاجر — ليس بيعًا ولا شراءً' },
  mloanOrderWasLoan: { en: 'This was a merchant loan, not a sale', ar: 'هذا كان قرض تاجر وليس بيعًا' },
  ...
  calPayments: { en: 'Payments', ar: 'الدفعات' },
  calPaymentsReceived: { en: 'payment(s) received', ar: 'دفعة مستلمة' },
  calCustomer: { en: 'Customer', ar: 'العميل' },
  ...
  splitOrderToggle: { en: 'Split this order between two customers', ar: 'تقسيم هذا الطلب بين عميلين' },
  splitOrderHint: { en: 'Move part of this order to a different customer — the rest stays on this order.', ar: 'انقل جزءًا من هذا الطلب إلى عميل آخر — يبقى الباقي على هذا الطلب.' },
  splitAmountLabel: { en: 'Amount to move (USDT)', ar: 'الكمية المراد نقلها (USDT)' },
  ...
  insufficientStockTitle: { en: 'Insufficient stock', ar: 'مخزون غير كافٍ' },
  insufficientStockShortBy: { en: 'Insufficient stock: short by {qty} USDT', ar: 'المخزون غير كافٍ: يوجد عجز قدره {qty} USDT' },
  orderExceedsStockBy: { en: 'This order exceeds available stock by {qty}', ar: 'هذا الطلب يتجاوز المخزون المتاح بمقدار {qty}' },
  fifoCannotFullyPrice: { en: 'FIFO cannot fully price this sale.', ar: 'لا يمكن لـ FIFO تسعير هذه الصفقة بالكامل.' },
  toContinueEither: { en: 'To continue, either:', ar: 'للمتابعة، إمّا:' },
  addStockFirst: { en: 'add stock first', ar: 'أضف مخزونًا أولاً' },
  enableManualSellPriceOverride: { en: 'or enable Manual Sell Price override', ar: 'أو فعّل تجاوز سعر البيع اليدوي' },
  addStockCta: { en: 'Add Stock', ar: 'إضافة مخزون' },
  useManualSellPriceCta: { en: 'Use Manual Sell Price', ar: 'استخدم سعر البيع اليدوي' },
  stockOverrideConfirm: { en: 'I confirm this sale has uncovered FIFO quantity and will be saved with manual cost-basis override metadata.', ar: 'أؤكد أن هذه الصفقة تحتوي كمية غير مغطاة من FIFO وسيتم حفظها ببيانات تجاوز أساس تكلفة يدوي.' },
  fifoCoverageIncomplete: { en: 'FIFO coverage incomplete.', ar: 'تغطية FIFO غير مكتملة.' },
  coveredQtyLabel: { en: 'Covered', ar: 'مغطّى' },
  uncoveredQtyLabel: { en: 'Uncovered', ar: 'غير مغطّى' },
  allocationNetWithheld: { en: 'Allocation net profit is withheld until stock is fully covered or override is confirmed.', ar: 'يتم حجب صافي ربح التوزيع حتى يكتمل تغطية المخزون أو يتم تأكيد التجاوز.' },
  coveredFifoQty: { en: 'Covered FIFO qty', ar: 'الكمية المغطاة من FIFO' },
  uncoveredQty: { en: 'Uncovered qty', ar: 'الكمية غير المغطاة' },
  netIncompleteUncovered: { en: 'Net profit is incomplete for uncovered quantity and is not shown as authoritative FIFO.', ar: 'صافي الربح غير مكتمل للكمية غير المغطاة ولا يُعرض كقيمة FIFO موثوقة.' },
  ...
  cashCounterConfirmAdd: { en: 'Add to Cash',                  ar: 'إضافة إلى النقد' },
  cashCounterStepCount:  { en: 'Count',                        ar: 'العدّ' },
  cashCounterStepChoose: { en: 'Choose',                       ar: 'الاختيار' },
  cashCounterStepConfirm:{ en: 'Confirm',                      ar: 'التأكيد' },
  cashCounterRecount:    { en: '✏️ Recount',                   ar: '✏️ إعادة العدّ' },
  cashCounterSplitLoans: { en: 'Split across several loans',   ar: 'تقسيم على عدة قروض' },
  cashCounterSplitNeedTwo: { en: 'Needs at least 2 open loans', ar: 'يتطلب قرضين مفتوحين على الأقل' },
  cashCounterSplitLoansDesc: { en: 'Divide this cash across multiple customers', ar: 'توزيع هذا المبلغ على عدة عملاء' },
  ...
  cashCounterConfirmSplit: { en: 'Apply Split Repayment',      ar: 'تطبيق السداد المقسّم' },
  cashCounterSplitMinTwo: { en: 'Select at least two loans to split across.', ar: 'اختر قرضين على الأقل للتقسيم بينهما.' },
  cashCounterSplitOverAllocated: { en: 'Allocated amount exceeds what you counted.', ar: 'المبلغ الموزّع يتجاوز ما قمت بعدّه.' },
  cashCounterModeNotes:  { en: 'Count notes',                  ar: 'عدّ الأوراق النقدية' },
  cashCounterModeAmount: { en: 'Enter total',                  ar: 'إدخال الإجمالي' },
  cashCounterQuickAmountLbl: { en: 'Total amount',             ar: 'المبلغ الإجمالي' },
  cashCounterQuickAmountHint: { en: 'You can type shorthand like 50k or 1.2m', ar: 'يمكنك كتابة اختصار مثل 50k أو 1.2m' },
  cashCounterDateLbl:    { en: 'Date',                         ar: 'التاريخ' },
  saveFailed:            { en: 'Save failed',                  ar: 'فشل الحفظ' },
  statementsTabDesc: { en: 'View a buyer\'s statement right here, or copy a read-only link for them to view it themselves — no login required.', ar: 'اطّلع على كشف حساب العميل هنا مباشرة، أو انسخ رابطًا للقراءة فقط ليطّلع عليه بنفسه دون تسجيل دخول.' },
  statementReportView: { en: 'View statement', ar: 'عرض الكشف' },
  statementReportHide: { en: 'Hide', ar: 'إخفاء' },
  statementLinkCopy: { en: 'Copy external link', ar: 'نسخ رابط خارجي' },
  statementLinkRevoke: { en: 'Revoke', ar: 'إلغاء' },
  statementLinkCreateFailed: { en: 'Could not load statement', ar: 'تعذر تحميل الكشف' },
  statementLinkCopied: { en: 'Link copied', ar: 'تم نسخ الرابط' },
  statementLinkCopyFailed: { en: 'Could not copy link', ar: 'تعذر نسخ الرابط' },
  statementLinkRevoked: { en: 'Statement link revoked', ar: 'تم إلغاء رابط الكشف' },
  statementLinkRevokeFailed: { en: 'Could not revoke statement link', ar: 'تعذر إلغاء رابط الكشف' },
  statementLinkLoadFailed: { en: 'Could not load statement links', ar: 'تعذر تحميل روابط الكشوفات' },
  statementLinkPortalAttachNone: { en: 'Not shared in app', ar: 'غير مشارك داخل التطبيق' },
  statementLinkPortalAttachHint: { en: 'Let this buyer view this statement in their portal', ar: 'اسمح لهذا العميل بمشاهدة هذا الكشف داخل حسابه' },
  statementLinkPortalAttachSaved: { en: 'Statement sharing updated', ar: 'تم تحديث مشاركة الكشف' },
  statementLinkPortalAttachFailed: { en: 'Could not update statement sharing', ar: 'تعذر تحديث مشاركة الكشف' },
  loans:                 { en: 'Customer Loans',               ar: 'قروض العملاء' },
  newLoan:               { en: '+ New Loan',                   ar: '+ قرض جديد' },
  loanCustomer:          { en: 'Customer',                     ar: 'العميل' },
  loanPrincipal:         { en: 'Principal',                    ar: 'المبلغ الأساسي' },
  loanGiven:             { en: 'Given',                        ar: 'المُعطى' },
  loanReceived:          { en: 'Received',                     ar: 'المُستلم' },
  loanRemaining:         { en: 'Remaining',                    ar: 'المتبقي' },
  ...
  loanSplitPaymentTotal: { en: 'Total across selected orders',  ar: 'الإجمالي عبر الطلبات المحددة' },
  loanSplitPaymentSave:  { en: 'Record split payment',          ar: 'تسجيل الدفعة المقسمة' },
  loanSplitPaymentAmountReceived: { en: 'Amount received', ar: 'المبلغ المستلم' },
  loanSplitPaymentAllocated: { en: 'Allocated to orders', ar: 'الموزع على الطلبات' },
  loanSplitPaymentUnallocated: { en: 'Unallocated', ar: 'غير موزع' },
  loanSplitPaymentEnterAmount: { en: 'Enter the amount received', ar: 'أدخل المبلغ المستلم' },
  loanSplitPaymentPickOne: { en: 'Select at least one order', ar: 'اختر طلبًا واحدًا على الأقل' },
  loanSplitPaymentMustMatch: { en: 'Allocated amounts must add up to the amount received', ar: 'يجب أن يساوي مجموع المبالغ الموزعة المبلغ المستلم' },
  loanMergePayments: { en: 'Merge into one payment', ar: 'دمج في دفعة واحدة' },
  ...
  noLoansYet:            { en: 'No customer loans yet',         ar: 'لا توجد قروض عملاء بعد' },
  ...
  loanColBuyer: { en: 'Buyer', ar: 'المشتري' },
  loanColOrders: { en: 'Orders', ar: 'الطلبات' },
  loanColLoaned: { en: 'Loaned', ar: 'المُقرَض' },
  loanColRepaid: { en: 'Repaid', ar: 'المسدد' },
  loanColOutstanding: { en: 'Outstanding', ar: 'المستحق' },
  loanColLastPayment: { en: 'Last payment', ar: 'آخر دفعة' },
  loanColAge: { en: 'Age', ar: 'العمر' },
  loanColStatus: { en: 'Status', ar: 'الحالة' },
  loanColRef: { en: 'Ref', ar: 'المرجع' },
  loanColDate: { en: 'Date', ar: 'التاريخ' },
  loanColDescription: { en: 'Description', ar: 'البيان' },
  loanColAmount: { en: 'Amount', ar: 'المبلغ' },
  loanColPaid: { en: 'Paid', ar: 'المدفوع' },
  loanColRemaining: { en: 'Remaining', ar: 'المتبقي' },
  loanColAccount: { en: 'Account', ar: 'الحساب' },
  loanColDebit: { en: 'Debit (+)', ar: 'مدين (+)' },
  loanColCredit: { en: 'Credit (−)', ar: 'دائن (−)' },
  loanColBalance: { en: 'Balance', ar: 'الرصيد' },
  loanBuyersOwing: { en: 'buyers owing', ar: 'مشترٍ مدين' },
  loanNoOutstanding: { en: 'No buyer owes anything — the book is clear', ar: 'لا يوجد مشترٍ مدين — الدفتر صافٍ' },
  loanOrdersUnit: { en: 'orders', ar: 'طلبات' },
  loanDaysShort: { en: 'd', ar: 'ي' },
  loanOverdueTag: { en: 'overdue', ar: 'متأخر' },

  // Loans page — statement of account
  loanStatement: { en: 'Statement', ar: 'كشف حساب' },
  loanStatementFor: { en: 'Statement of account', ar: 'كشف حساب' },
  loanStatementOpen: { en: 'Open statement', ar: 'فتح كشف الحساب' },
  loanExportPdf: { en: 'Print / PDF', ar: 'طباعة / PDF' },
  loanExportExcel: { en: 'Excel (CSV)', ar: 'إكسل (CSV)' },
  loanCopySummary: { en: 'Copy summary', ar: 'نسخ الملخص' },
  loanCopied: { en: 'Summary copied', ar: 'تم نسخ الملخص' },
  loanCopyFailed: { en: 'Could not copy', ar: 'تعذّر النسخ' },
  loanExported: { en: 'Statement downloaded', ar: 'تم تنزيل الكشف' },
  loanPrintUnavailable: { en: 'Printing is not available here — downloaded the spreadsheet instead', ar: 'الطباعة غير متاحة هنا — تم تنزيل الملف بدلاً من ذلك' },
  stmtTitle: { en: 'Statement of Account', ar: 'كشف حساب' },
  stmtIssuedBy: { en: 'Issued by', ar: 'صادر عن' },
  stmtBillTo: { en: 'Statement for', ar: 'كشف حساب لـ' },
  stmtPhone: { en: 'Phone', ar: 'الهاتف' },
  stmtDate: { en: 'Statement date', ar: 'تاريخ الكشف' },
  stmtPeriod: { en: 'Period', ar: 'الفترة' },
  stmtSummary: { en: 'Total', ar: 'الإجمالي' },
  stmtLoanedOrders: { en: 'Loaned orders', ar: 'الطلبات بالدين' },
  loanOfWordLbl: { en: 'of', ar: 'من' },
  loanOpenWordLbl: { en: 'open', ar: 'مفتوح' },
  ...
  stmtPayment: { en: 'Payment received', ar: 'دفعة مستلمة' },
  stmtTotalDue: { en: 'Total due', ar: 'إجمالي المستحق' },
  stmtAging: { en: 'Aging of outstanding', ar: 'أعمار المستحقات' },
  stmtAgingCurrent: { en: '0–30 days', ar: '0–30 يوم' },
  stmtAging31: { en: '31–60 days', ar: '31–60 يوم' },
  stmtAging61: { en: '61–90 days', ar: '61–90 يوم' },
  stmtAging90: { en: 'Over 90 days', ar: 'أكثر من 90 يوم' },
  stmtNoEntries: { en: 'Nothing recorded yet', ar: 'لا توجد حركات بعد' },
  stmtGeneratedOn: { en: 'Generated', ar: 'تم الإنشاء' },
  stmtOpeningBalance: { en: 'Opening balance', ar: 'الرصيد الافتتاحي' },
  stmtFooterNote: {
    en: 'This statement covers every loaned order and payment recorded to date.',
  ...
  amountFromNotesHint:    { en: 'Calculated from the banknote breakdown below', ar: 'محسوب من تفصيل الفئات النقدية أدناه' },
  ...
  // ── Cash Custody ──
  merchantCash:                 { en: 'Merchant Cash',                                  ar: 'نقد التاجر' },
  merchantCashCustody:          { en: 'Merchant Cash Custody',                           ar: 'حفظ نقد التاجر' },
  selectMerchantCustodian:      { en: 'Select Merchant (Custodian)',                     ar: 'اختر التاجر (الحافظ)' },
  selectRelationship:           { en: 'Select relationship...',                          ar: 'اختر العلاقة...' },
  noApprovedRelationships:      { en: 'No approved merchant relationships available',    ar: 'لا توجد علاقات تاجر معتمدة متاحة' },
  sendCustodyRequest:           { en: 'Send Custody Request',                            ar: 'إرسال طلب الحفظ' },
  pendingCustodyRequests:       { en: 'Pending Custody Requests',                        ar: 'طلبات الحفظ المعلقة' },
  custodyIncoming:              { en: 'Incoming',                                        ar: 'وارد' },
  custodyOutgoing:              { en: 'Outgoing',                                        ar: 'صادر' },
  custodyAccept:                { en: 'Accept',                                          ar: 'قبول' },
  custodyReject:                { en: 'Reject',                                          ar: 'رفض' },
  custodyCancel:                { en: 'Cancel',                                          ar: 'إلغاء' },
  custodyRequestSent:           { en: 'Cash custody request sent',                       ar: 'تم إرسال طلب حفظ النقد' },
  custodyRequestAccepted:       { en: 'Request accepted',                                ar: 'تم قبول الطلب' },
  custodyRequestRejected:       { en: 'Request rejected',                                ar: 'تم رفض الطلب' },
  custodyRequestCancelled:      { en: 'Request cancelled',                               ar: 'تم إلغاء الطلب' },
  invalidRelationship:          { en: 'Invalid relationship',                            ar: 'علاقة غير صالحة' },
  selectedMerchantInvalid:      { en: 'Selected merchant is invalid',                    ar: 'التاجر المختار غير صالح' },
  missingMerchantUserMapping:   { en: 'Missing merchant user mapping',                   ar: 'تعيين مستخدم التاجر مفقود' },
  cannotSendToYourself:         { en: 'Cannot send request to yourself',                 ar: 'لا يمكنك إرسال الطلب لنفسك' },
  custodyNoteOptional:          { en: 'Note (optional)',                                  ar: 'ملاحظة (اختياري)' },
  custodyRequestDesc:           { en: 'Request a merchant to hold cash on your behalf. They will receive a notification to accept or counter-propose.', ar: 'اطلب من تاجر حفظ النقد نيابة عنك. سيتلقى إشعاراً للقبول أو تقديم عرض مقابل.' },
  custodyPending:               { en: 'pending',                                         ar: 'معلق' },
  custodyOutgoingTo:            { en: 'Outgoing to',                                     ar: 'صادر إلى' },
  custodyAcceptedFrom:          { en: 'Custody accepted from',                           ar: 'تم قبول الحفظ من' },
  custodyCustodyRequest:        { en: 'Custody request to',                              ar: 'طلب حفظ إلى' },
  stockTabLabel:                { en: 'Stock',                                           ar: 'المخزون' },
  linkToMerchant:               { en: 'Link to Merchant',                                ar: 'ربط بالتاجر' },

  // ── Customer Portal ──
  customerPortal:               { en: 'Customer Portal',                                 ar: 'بوابة العملاء' },
  customerHome:                 { en: 'Home',                                            ar: 'الرئيسية' },
  myMerchants:                  { en: 'My Merchants',                                    ar: 'تجاري' },
  ...
  buyUsdt:                      { en: 'Buy USDT',                                         ar: 'شراء USDT' },
  sellUsdt:                     { en: 'Sell USDT',                                        ar: 'بيع USDT' },
  orderPlaced:                  { en: 'Order placed!',                                    ar: 'تم تقديم الطلب!' },
  orderHistory:                 { en: 'Order History',                                    ar: 'سجل الطلبات' },
  noConnectedMerchants:         { en: 'No merchants connected yet',                      ar: 'لا يوجد تجار متصلين بعد' },
  addMerchantByCode:            { en: 'Search by Merchant ID or Code above to get started', ar: 'ابحث بمعرف التاجر أو الرمز أعلاه للبدء' },
  availableLiquidity:           { en: 'Available Liquidity',                              ar: 'السيولة المتاحة' },
  customerOnboardTitle:         { en: 'Set Up Your Profile',                              ar: 'إعداد ملفك الشخصي' },
  customerOnboardDesc:          { en: 'Tell us a bit about yourself to get started',      ar: 'أخبرنا قليلاً عن نفسك للبدء' },
  customerDisplayName:          { en: 'Display Name',                                     ar: 'اسم العرض' },
  ...
  iAmCustomer:                  { en: 'Customer',                                         ar: 'عميل' },
  merchantRoleDesc:             { en: 'Trade & manage stock',                             ar: 'تداول وإدارة المخزون' },
  customerRoleDesc:             { en: 'Buy & sell with merchants',                        ar: 'شراء وبيع مع التجار' },
  ...
  // ── Customer Portal (Phase 5-6) ──
  customerWallet:               { en: 'Wallet',                                           ar: 'المحفظة' },
  availableBalance:             { en: 'Available',                                        ar: 'متاح' },
  pendingBalance:               { en: 'Pending',                                          ar: 'معلق' },
  heldBalance:                  { en: 'Held',                                             ar: 'محجوز' },
  transactionLedger:            { en: 'Transaction Ledger',                               ar: 'سجل المعاملات' },
  downloadReceipt:              { en: 'Download Receipt',                                 ar: 'تحميل الإيصال' },
  trustMetrics:                 { en: 'Trust Metrics',                                    ar: 'مقاييس الثقة' },
  completionRate:               { en: 'Completion Rate',                                  ar: 'معدل الإتمام' },
  avgResponseTime:              { en: 'Avg Response Time',                                ar: 'متوسط وقت الاستجابة' },
  preferredMerchant:            { en: 'Preferred',                                        ar: 'مفضل' },
  customerOrdersTab:            { en: 'Customer Orders',                                  ar: 'طلبات العملاء' },
  clientManagement:             { en: 'Client Management',                                ar: 'إدارة العملاء' },
  newClientRequest:             { en: 'New Client Request',                               ar: 'طلب عميل جديد' },
  ...
  paymentSent:                  { en: 'Payment Sent',                                     ar: 'تم الإرسال' },
  ...
  privacyScore:                 { en: 'Privacy',                                          ar: 'الخصوصية' },
  basicPrivacy:                 { en: 'Basic Privacy',                                    ar: 'خصوصية أساسية' },
  moderatePrivacy:              { en: 'Moderate Privacy',                                 ar: 'خصوصية متوسطة' },
  strongPrivacy:                { en: 'Strong Privacy',                                   ar: 'خصوصية قوية' },
  maximumPrivacy:               { en: 'Maximum Privacy',                                  ar: 'خصوصية قصوى' },
  enableMaxPrivacy:             { en: 'Enable Maximum Privacy ⚡',                        ar: 'تفعيل الخصوصية القصوى ⚡' },
  activityReceipts:             { en: 'Activity & Receipts',                              ar: 'النشاط والإيصالات' },
  hideReadReceipts:             { en: 'Hide read receipts',                               ar: 'إخفاء إيصالات القراءة' },
  hideReadReceiptsDesc:         { en: "Others won't see when you've read their messages",  ar: 'لن يرى الآخرون متى قرأت رسائلهم' },
  hideLastSeen:                 { en: 'Hide last seen',                                   ar: 'إخفاء آخر ظهور' },
  hideLastSeenDesc:             { en: "Your last active time won't be visible to others",  ar: 'لن يكون وقت نشاطك الأخير مرئياً للآخرين' },
  hideTypingIndicator:          { en: 'Hide typing indicator',                            ar: 'إخفاء مؤشر الكتابة' },
  hideTypingIndicatorDesc:      { en: "Others won't see when you're typing a message",    ar: 'لن يرى الآخرون عندما تكتب رسالة' },
  onlinePresence:               { en: 'Online Presence',                                  ar: 'التواجد عبر الإنترنت' },
  invisibleMode:                { en: 'Invisible mode',                                   ar: 'وضع التخفي' },
  invisibleModeDesc:            { en: 'Appear offline while still receiving messages',     ar: 'اظهر كغير متصل مع الاستمرار في استقبال الرسائل' },
  notificationPrivacy:          { en: 'Notification Privacy',                             ar: 'خصوصية الإشعارات' },
  hideNotificationContent:      { en: 'Hide notification content',                        ar: 'إخفاء محتوى الإشعارات' },
  hideNotificationContentDesc:  { en: "Show 'New message' instead of message preview",    ar: "عرض 'رسالة جديدة' بدلاً من معاينة الرسالة" },
  hideSenderName:               { en: 'Hide sender name',                                 ar: 'إخفاء اسم المرسل' },
  hideSenderNameDesc:           { en: "Don't show who sent the message in notifications",  ar: 'لا تُظهر من أرسل الرسالة في الإشعارات' },
  contentProtection:            { en: 'Content Protection',                               ar: 'حماية المحتوى' },
  screenshotProtection:         { en: 'Screenshot protection',                            ar: 'حماية لقطات الشاشة' },
  screenshotProtectionDesc:     { en: 'Detect screenshots and blur content when window loses focus', ar: 'اكتشاف لقطات الشاشة وتمويه المحتوى عند فقدان تركيز النافذة' },
  watermarkOverlay:             { en: 'Watermark overlay',                                ar: 'طبقة العلامة المائية' },
  watermarkOverlayDesc:         { en: 'Add invisible watermark to sensitive message areas', ar: 'إضافة علامة مائية غير مرئية لمناطق الرسائل الحساسة' },
  disableForwarding:            { en: 'Disable forwarding',                               ar: 'تعطيل إعادة التوجيه' },
  disableForwardingDesc:        { en: 'Prevent messages from being forwarded to other rooms', ar: 'منع إعادة توجيه الرسائل إلى غرف أخرى' },
  disableCopy:                  { en: 'Disable copy',                                     ar: 'تعطيل النسخ' },
  disableCopyDesc:              { en: 'Block text copying from messages in protected rooms', ar: 'منع نسخ النصوص من الرسائل في الغرف المحمية' },
  disableExport:                { en: 'Disable export',                                   ar: 'تعطيل التصدير' },
  disableExportDesc:            { en: 'Prevent chat export and transcript downloads',     ar: 'منع تصدير الدردشة وتنزيل النصوص' },
  identity:                     { en: 'Identity',                                         ar: 'الهوية' },
  anonymousMode:                { en: 'Anonymous mode',                                   ar: 'الوضع المجهول' },
  anonymousModeDesc:            { en: 'Use a pseudonymous name in new rooms you join',    ar: 'استخدام اسم مستعار في الغرف الجديدة التي تنضم إليها' },

  // ── Chat workspace ──
  chatSearchPlaceholder:        { en: 'Search conversations...',                          ar: 'بحث في المحادثات...' },
  newChat:                      { en: 'New Chat',                                         ar: 'محادثة جديدة' },
  chatOnline:                   { en: 'online',                                           ar: 'متصل' },
  chatOffline:                  { en: 'offline',                                          ar: 'غير متصل' },
  chatTyping:                   { en: 'typing...',                                        ar: 'يكتب...' },
  chatMembers:                  { en: 'members',                                          ar: 'أعضاء' },
  roomInfo:                     { en: 'Room Info',                                        ar: 'معلومات الغرفة' },
  muteNotifications:            { en: 'Mute notifications',                               ar: 'كتم الإشعارات' },
  unmuteNotifications:          { en: 'Unmute notifications',                             ar: 'إلغاء كتم الإشعارات' },
  clearChat:                    { en: 'Clear Chat',                                       ar: 'مسح الدردشة' },
  searchMessages:               { en: 'Search messages',                                  ar: 'بحث في الرسائل' },
  chatReply:                    { en: 'Reply',                                            ar: 'رد' },
  chatForward:                  { en: 'Forward',                                          ar: 'إعادة توجيه' },
