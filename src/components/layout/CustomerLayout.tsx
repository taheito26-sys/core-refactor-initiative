...
import { Home, ShoppingCart, Wallet, MessageCircle, Menu, X, Settings, Store, Bell, LogOut, HandCoins, type LucideIcon } from 'lucide-react';
...
const DRAWER_NAV = [
  { path: '/c/loan',          icon: HandCoins,  en: 'Loaned Orders', ar: 'الطلبات المؤجّلة' },
