                ...
                if (isMobile) {
                  ...
                  return (
                    ...
                    >
                      ...
                      <div className={cn('mt-4 font-mono text-[11px] font-semibold tracking-[0.02em] text-slate-400', lang === 'ar' && 'text-right')}>
                      ...
                      <div className={cn('mt-3 flex items-baseline justify-between gap-3', lang === 'ar' && 'flex-row-reverse')}>
                        ...
                        <div className="shrink-0 text-right text-[11px] text-slate-400">
                          {L('Balance', 'الرصيد')}: <span className="font-semibold text-slate-50">{receiveAmountLabel} {receiveCurrencyLabel}</span>
                        </div>
                      </div>

                      <div className={cn('mt-3 text-[11px] leading-5 text-slate-400', lang === 'ar' && 'text-right')}>
