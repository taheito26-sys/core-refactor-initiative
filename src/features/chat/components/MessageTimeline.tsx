...
export function MessageTimeline({
  messages, currentUserId, counterpartyName, scrollRef, onAcceptDeal, onConvertMessage, onReply, identitiesById
}: Props) {
          ...
          {g.msgs.map((item, i) => {
            ...
            return (
              <MessageItem
                ...
                onReply={onReply} onConvert={(type:any) => onConvertMessage?.(msg.id, type)} identitiesById={identitiesById}
              />
            );
          })}
        </div>
