...
export function ConversationHeader({
  ...
  return (
    <header className="sticky top-0 z-30 h-[54px] border-b border-border flex items-center justify-between px-3 md:px-4 bg-background/90 backdrop-blur-md shrink-0 gap-2">
