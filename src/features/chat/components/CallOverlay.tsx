...
export function CallOverlay({ webrtc }: Props) {
    ...
    return (
      <div className="fixed inset-0 z-50 bg-black flex flex-col">
        ...
        <div className="flex-1 relative">
          ...
          {/* Status bar */}
          <div className="absolute top-0 inset-x-0 p-4 bg-gradient-to-b from-black/60 to-transparent safe-area-top">
        ...
        {/* Controls bar */}
        <div className="bg-black/90 backdrop-blur-md px-6 py-6 flex items-center justify-center gap-4 safe-area-bottom">
          <button
            onClick={toggleMute}
            className={cn(
          ...
          <button
            onClick={hangUp}
            className="h-16 w-16 rounded-full bg-destructive text-white flex items-center justify-center shadow-lg shadow-red-500/30 active:scale-95 transition-transform"
          >
  ...
  // Mobile full-screen incoming call overlay (iPhone style)
  if (isMobile && isRinging) {
    return (
      <div className="fixed inset-0 z-50 bg-gradient-to-b from-slate-900 via-slate-800 to-slate-900 flex flex-col items-center justify-between pointer-events-auto safe-area-inset">
        <audio ref={remoteAudioRef} autoPlay playsInline className="hidden" />
        
        {/* Top section - Status */}
        <div className="w-full pt-12 px-6 text-center">
          <p className="text-slate-400 text-sm font-medium mb-2">Incoming Call</p>
        </div>
        ...
        <div className="flex-1 flex flex-col items-center justify-center -mt-20">
          ...
          <div className="relative mb-8">
            <div className="absolute inset-0 rounded-full bg-emerald-500/20 animate-ping" style={{ width: 140, height: 140, top: -10, left: -10 }} />
            <div className="absolute inset-0 rounded-full bg-emerald-500/10 animate-pulse" style={{ width: 140, height: 140, top: -10, left: -10, animationDelay: '0.5s' }} />
            <div className="h-32 w-32 rounded-full bg-gradient-to-br from-emerald-500 to-emerald-600 border-4 border-emerald-400/30 flex items-center justify-center shadow-2xl shadow-emerald-500/20">
              <User className="h-16 w-16 text-white" strokeWidth={1.5} />
            </div>
          </div>

          <h2 className="text-white text-3xl font-semibold mb-2">Contact</h2>
          <p className="text-emerald-400 text-base font-medium">mobile</p>
        </div>
          ...
          <div className="flex items-center justify-center gap-20 mb-8">
            ...
            <div className="flex flex-col items-center gap-3">
              <button
                ...
                className="h-20 w-20 rounded-full bg-emerald-500 text-white flex items-center justify-center shadow-lg shadow-emerald-500/40 active:scale-90 transition-transform"
              >
  ...
  // Mobile full-screen audio call UI (iPhone style) - when connected
  if (isMobile && isActive && !showVideo) {
    return (
      <div className="fixed inset-0 z-50 bg-gradient-to-b from-slate-900 via-slate-800 to-slate-900 flex flex-col items-center justify-between pointer-events-auto safe-area-inset">
        <audio ref={remoteAudioRef} autoPlay playsInline className="hidden" />
        
        {/* Top section - Status and quality */}
        ...
        {/* Middle section - Avatar, name, and duration */}
        <div className="flex-1 flex flex-col items-center justify-center -mt-20">
          {/* Avatar */}
          <div className="relative mb-8">
            <div className="h-40 w-40 rounded-full bg-gradient-to-br from-emerald-500 to-emerald-600 border-4 border-emerald-400/20 flex items-center justify-center shadow-2xl shadow-emerald-500/10">
          ...
          <h2 className="text-white text-3xl font-semibold mb-3">Contact</h2>
          
          {/* Call duration */}
          <div className="text-emerald-400 text-xl font-mono font-medium">
            {formatDuration(callDuration)}
          </div>

          {/* Muted indicator */}
          {isMuted && (
            <div className="mt-4 flex items-center gap-2 px-4 py-2 rounded-full bg-red-500/20 border border-red-500/30">
        ...
        <div className="w-full px-6 pb-12">
          ...
          <div className="grid grid-cols-3 gap-8 mb-8">
              ...
              <button
                ...
                className={cn(
                  ...
                  isMuted 
                    ...
                    : 'bg-slate-700/80 text-white shadow-slate-900/50',
                )}
              >
            ...
            <div className="flex flex-col items-center gap-2">
              <button
                onClick={toggleVideo}
                className="h-16 w-16 rounded-full bg-slate-700/80 text-white flex items-center justify-center transition-all active:scale-90 shadow-lg shadow-slate-900/50"
              >
            ...
            <div className="flex flex-col items-center gap-2 opacity-0 pointer-events-none">
              <div className="h-16 w-16 rounded-full bg-slate-700/80" />
  ...
  // Mobile calling/connecting states (full-screen)
    ...
    return (
      <div className="fixed inset-0 z-50 bg-gradient-to-b from-slate-900 via-slate-800 to-slate-900 flex flex-col items-center justify-between pointer-events-auto safe-area-inset">
        ...
        <div className="flex-1 flex flex-col items-center justify-center -mt-20">
          <div className="relative mb-8">
            {/* Animated rings */}
            <div className="absolute inset-0 rounded-full bg-blue-500/20 animate-ping" style={{ width: 140, height: 140, top: -10, left: -10 }} />
            <div className="h-32 w-32 rounded-full bg-gradient-to-br from-blue-500 to-blue-600 border-4 border-blue-400/30 flex items-center justify-center shadow-2xl shadow-blue-500/20">
              <User className="h-16 w-16 text-white" strokeWidth={1.5} />
            </div>
          </div>

          <h2 className="text-white text-3xl font-semibold mb-2">Contact</h2>
          <p className="text-blue-400 text-base font-medium">mobile</p>

          {/* Spinner */}
          <div className="mt-8 h-6 w-6 border-2 border-blue-400 border-t-transparent rounded-full animate-spin" />
        </div>

        {/* Bottom section */}
        <div className="w-full px-8 pb-12 flex justify-center">
          <button
            onClick={hangUp}
            className="h-16 w-16 rounded-full bg-red-500 text-white flex items-center justify-center shadow-lg shadow-red-500/40 active:scale-90 transition-transform"
          >
  ...
  // Desktop or non-active mobile states - compact overlay bar
  return (
    <div className={cn(
