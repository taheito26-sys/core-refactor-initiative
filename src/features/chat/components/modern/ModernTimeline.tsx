...
import { Play, Check, Flame, ShieldAlert, FileText, CheckCircle, RefreshCw, Send, Lock } from 'lucide-react';
import { OsMessage, OsBusinessObject, MOCK_IDENTITIES } from '@/lib/os-store';
...
export function ModernTimeline({ messages, currentUserId, counterpartyName, onAcceptDeal, onConvertMessage }: Props) {
...
function ModernMessageItem({ message, isOwn, isFirstInGroup, counterpartyName, onConvert }: any) {
