-- Approval-first customer order flow with optional cash-account links.

ALTER TABLE public.customer_orders
  ADD COLUMN IF NOT EXISTS merchant_cash_account_id text,
  ADD COLUMN IF NOT EXISTS merchant_cash_account_name text,
  ADD COLUMN IF NOT EXISTS customer_cash_account_id text,
  ADD COLUMN IF NOT EXISTS customer_cash_account_name text;
